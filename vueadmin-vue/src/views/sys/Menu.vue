    ...
    export default {
        ...
        methods: {
            ...
            submitForm(formName) {
                this.$refs[formName].validate((valid) => {
                    if (valid) {
                        ...
                        if (this.editForm.id) {
                            this.$axios.put('/sys/menus', this.editForm).then(callback)
                        } else {
                            this.$axios.post('/sys/menus', this.editForm).then(callback)
                        }
            ...
            editHandle(id) {
                ...
                this.$axios.get('/sys/menus/' + id).then(res => {
            ...
            deleteHandle(id) {
                this.$axios.delete('/sys/menus/' + id).then(res => {
                    this.$message({
                        showClose: true,
                        message: '恭喜你，操作成功',
                        type: 'success',
