...
<script>
    export default {
        ...
        created() {
            ...
            this.$axios.get("/sys/roles").then(res => {
        ...
        methods: {
            ...
            submitForm(formName) {
                this.$refs[formName].validate((valid) => {
                    if (valid) {
                        ...
                        if (this.editForm.id) {
                            this.$axios.put('/sys/users', this.editForm).then(callback)
                        } else {
                            this.$axios.post('/sys/users', this.editForm).then(callback)
                        }
                    } else {
            ...
            editHandle(id) {
                this.$axios.get('/sys/users/' + id).then(res => {
            ...
            delHandle(id) {
                ...
                this.$axios.delete("/sys/users", ids).then(res => {
                    this.$message({
                        showClose: true,
                        message: '恭喜你，操作成功',
                        type: 'success',
            ...
            submitRoleHandle(formName) {
                ...
                this.$axios.post('/sys/users/' + this.roleForm.id + '/roles' , roleIds).then(res => {
                    this.$message({
                        showClose: true,
                        message: '恭喜你，操作成功',
                        type: 'success',
            ...
            repassHandle(id, username) {
                ...
                this.$confirm('将重置用户【' + username + '】的密码, 是否继续?', '提示', {
                    ...
                    this.$axios.put("/sys/users/" + id).then(res => {
                        this.$message({
                            showClose: true,
                            message: '恭喜你，操作成功',
                            type: 'success',
