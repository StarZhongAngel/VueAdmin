...
Mock.mock('/captcha', 'get', () => {
    ...
    Result.data = {
        ...
        captchaImg: Random.dataImage('100x40', 'p3rd4')
    }
...
Mock.mock('/sys/userInfo', 'get', () => {
    Result.data = {
        id: "1",
        username: "Test",
        avatar: "https://c.wallhere.com/images/bd/dd/276c5f600690f796040abfce7dab-1562445.jpg!s"
    }
...
Mock.mock(RegExp('/sys/menus/*'), 'get', () => {
...
Mock.mock(RegExp('/sys/menus'), 'post', () => {

    return Result
})

Mock.mock(RegExp('/sys/menus/*'), 'put', () => {

    return Result
})

Mock.mock(RegExp('/sys/menus/*'), 'delete', () => {
...
Mock.mock(RegExp('/sys/roles*'), 'get', () => {
...
Mock.mock(RegExp('/sys/roles'), 'post', () => {

    return Result
})
Mock.mock(RegExp('/sys/roles/*'), 'put', () => {

    return Result
})
Mock.mock(RegExp('/sys/roles/*'), 'delete', () => {
...
Mock.mock(RegExp('/sys/users*'), 'get', () => {
    Result.data = {
        "records": [
            {
                "id": 1,
...
Mock.mock(RegExp('/sys/users'), 'post', () => {
    return Result
})
Mock.mock(RegExp('/sys/users/*'), 'delete', () => {
    return Result
})
Mock.mock(RegExp('/sys/users/*'), 'put', () => {
    return Result
})
